...
class OrderedProductPrice():
    ...
    def test_Billing_Ammount_of_OrderProduct(self,setup):
        ...
        if self.Target_value==True:
            ...
            self.driver.save_screenshot(os.path.abspath(os.curdir)+"\\screenshots\\"+"test_Billing_Amount_of_OrderProduct")
            self.driver.close()
            assert False
